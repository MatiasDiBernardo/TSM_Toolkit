...
def hpsModel(x, fs, w, N, t, nH, minf0, maxf0, f0et, stocf):
    ...
    while pin < pend:
        ...
        # -----synthesis-----
        Yh = UF.genSpecSines_p(hfreq, hmag, hphase, Ns, fs)  # generate spec sines of harmonic component
        ...
        mXrenv = resample(np.maximum(-200, mXr),
                          int(mXr.size * stocf))  # decimate the magnitude spectrum and avoid -Inf
